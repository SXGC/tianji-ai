...
describe('events types', () => {
	...
	describe('RuntimeEventType', () => {
		...
		it('should define all tool event types', () => {
			const toolTypes: RuntimeEventType[] = [
				'tool.started',
				'tool.completed',
				'tool.failed',
			]
	...
	describe('Event filtering patterns', () => {
		it('should filter run events', () => {
			const events: RuntimeEvent[] = [
				...
				{ type: 'message.started', runId, messageId: 'm1', message: { id: 'm1', role: 'assistant', content: [], createdAt: 1000 }, timestamp: 1100 },
		...
		it('should filter message events', () => {
			const events: RuntimeEvent[] = [
				{ type: 'run.started', runId, sessionId, timestamp: 1000 },
				{ type: 'message.started', runId, messageId: 'm1', message: { id: 'm1', role: 'assistant', content: [], createdAt: 1000 }, timestamp: 1100 },
				{ type: 'message.delta', runId, messageId: 'm1', sequence: 1, channel: 'text', payload: { content: 'Hi' }, timestamp: 1110 },
				{ type: 'run.completed', runId, sessionId, timestamp: 2000 },
			]
		...
		it('should filter tool events', () => {
			const events: RuntimeEvent[] = [
				{ type: 'run.started', runId, sessionId, timestamp: 1000 },
				{ type: 'tool.started', runId, toolCallId: 't1', invocation: { toolCallId: 't1', toolName: 'test', args: {} }, timestamp: 1100 },
				{ type: 'tool.completed', runId, toolCallId: 't1', result: { toolCallId: 't1', result: 'done' }, timestamp: 1200 },
				{ type: 'run.completed', runId, sessionId, timestamp: 2000 },
			]
